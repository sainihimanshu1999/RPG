...
const locations = [
    ...
    {
        name: 'cave',
        'button text' : ['Fight Sime', 'Fight fanged beast', 'Go to Town Sqaure'],
        'button functions' : [fightSlime,fightBeast,goTown],
        text: 'You entered the cave and found some monsters'
    },
...

    {
        ...
        text: 'The monster screams "AAARGH" as it dies. You gain experience points and find gold.'
    },
...
function buyHealth(){
    if(gold>=10){
        ...
        text.innerText = 'You do not have enough gold for this';
    }
}
...
function goFight(){
    ...
    //console.log(monsterHealth,monsterHealthText,monsterNameText);
}
